#ifndef MSGR_DISPATCHER_0c5f22d5ed4f_H
#define MSGR_DISPATCHER_0c5f22d5ed4f_H
...
public:
   ...
   * You are not granted a reference to it -- take one if you need one!
   */
...
#endif // MSGR_DISPATCHER_0c5f22d5ed4f_H
