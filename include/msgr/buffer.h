#ifndef BUFFER_5a0c1acddffb4d50a33f4a60e85c9f64_H
#define BUFFER_5a0c1acddffb4d50a33f4a60e85c9f64_H
...
public:
  ...
  public:
    ...
    virtual unsigned consumed() const
    {
        return 0;
    }
    virtual bool is_page_aligned()
    {
        return ((long)data & ~MSGR_PAGE_MASK) == 0;
    }
    bool is_n_page_sized()
    {
        return (len & ~MSGR_PAGE_MASK) == 0;
    }
...
public:
  ...
  public:
    ...
    bool is_page_aligned() const { return is_aligned(MSGR_PAGE_SIZE); }
    bool is_n_align_sized(unsigned align) const
    {
      return (length() % align) == 0;
    }
    bool is_n_page_sized() const { return is_n_align_sized(MSGR_PAGE_SIZE); }
    ...
    unsigned consumed() const {
      assert(_raw);
      return _raw->consumed();
    }
  ...
  private:
    ...
    ssize_t zero_copy_to_fd(int fd) const;
  ...
  public:
    ...
    ssize_t write_file(const char *fn, int mode=0644);
    ssize_t write_fd(int fd) const;
    ssize_t write_fd_zero_copy(int fd) const;
...
#endif // BUFFER_5a0c1acddffb4d50a33f4a60e85c9f64_H
